package com.prueba.backendShoeStore.Controller.BaseController;
...
import com.prueba.backendShoeStore.Util.ApiResponseDto;
...
public class BaseController<T> {
	...
	@GetMapping("{id}")
	public Optional<T> findById(@PathVariable String id) throws Exception {
	...
	@PutMapping("{id}" )
	public ResponseEntity<ApiResponseDto<T>> update(@PathVariable String id, @RequestBody T instanceEntity) {
		try {
